"""Tests for ATF template generator"""
...
class TestATFTemplateGenerator:
    ...
    def test_create_file_with_template_type(self, tmp_path):
        ...
        output_path = tmp_path / "login.atf"
    ...
    def test_create_file_without_extension(self, tmp_path):
        """Test creating file without .atf extension"""
        output_path = tmp_path / "test"
        
        result = ATFTemplateGenerator.create_file(str(output_path), "basic")
        
        assert result is True
        assert Path(f"{output_path}.atf").exists()
    ...
    def test_create_file_creates_directories(self, tmp_path):
        ...
        output_path = tmp_path / "nested" / "dir" / "test.atf"
    ...
    def test_all_templates_are_valid_atf(self):
        """Test that all templates are valid ATF format"""
